            ...
            <div class="" style="width: 65vh ; margin-bottom:15%">
             <form method="post" action="database.php">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                      <label for="inputAddress">Lieu d'habitation ,avec précision :</label>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" id="adresse" placeholder="Apartment, studio, or floor" name="adresse">
                    </div>
                  </div>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="article" placeholder="Ex : Yopougon" name="article">
                  </div>
                  <div class="form-group col-md-6">
                    <label for="name"> quantité </label>
                    <input type="text" class="form-control" id="quantite" placeholder="Apartment, studio, or floor" name="quantite">
                  </div>
                  </div>
