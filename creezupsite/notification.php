...
<html lang="en">
  ...
  <body class="mx-2" style="background-color:white;">
      ...
      <main style="background-image:url('image/bg.jpg')">
        <div>
        <br> <br>
           <h1 style="text-align: center;">Votre commande à été validé avec succès , <br>
                                Merci d'etre passé(e)!!!</h1>
      ...
      <footer style="background-color:white;">
        <nav>
          <a href="#" style="margin-left:60%"> <strong>  </strong></a>      
          <a href="#" style="margin-left:5%"> <strong></strong> </a>        
          <a href="#" style="margin-left:5%"> <strong></strong></a>       
