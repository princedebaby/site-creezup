        ...
        <div class="d-flex justify-content-around  align-items-center">
            ...
            <div class="" style="width: 40vh; margin-bottom:10%">
                    ...
                    <video width="100%" height="320%" controls autoplay  >
                      <source src="image/sympaturage.mp4" type=video/mp4>
                  </video>
             ...
             <form method="post" action="database.php">
                    <div class="form-row " >
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="name" placeholder="Saisir votre nom" name="nom">
                      </div>
                    </div>
                  <div class="form-row">

                    <div class="form-group col-md-6">
                      <label for="inputAddress">Lieu d'habitation :</label>
                      <input type="text" class="form-control" id="habitation" placeholder="Ex : Yopougon" name="habitation">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="inputAddress2">précision et autres details: </label>
                      <input type="text" class="form-control" id="adresse" placeholder="Apartment, studio" name="adresse">
                    </div>
                  </div>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="article" placeholder="sympathurage 1.0" name="article">
                  </div>
                  <div class="form-group col-md-6">
                    <label for="name"> quantité </label>
                    <input type="text" class="form-control" id="quantite" placeholder="" name="quantite">
                  </div>
                  </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                        <button type="submit" class="btn btn-success col-md-6" style="width: 38vh">CLIQUEZ POUR COMMANDER</button>
                        </div>
                      </div>
